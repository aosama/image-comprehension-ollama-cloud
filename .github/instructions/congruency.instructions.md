---
description: "Mandatory authoring and pre-commit review gate: verify naming, comments, API, and validation congruency on every changed file before commit or push"
applyTo: "**"
---
