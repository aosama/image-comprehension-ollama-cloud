---
description: "Shell scripting guidelines: set -eu with optional pipefail, trap cleanup, jq/yq over ad-hoc parsing, safe expansions, POSIX compliance when possible, and mktemp for temporary files"
applyTo: '**/*.sh'
---
