---
description: "Markdown authoring rules: heading hierarchy, no hard wraps, fenced code blocks, footnote citations with semantic labels, and content structure requirements"
applyTo: '**/*.md'
---
...
- Do not hard wrap lines in markdown files. Let lines flow naturally and wrap according to the editor or viewer's width. This improves readability and makes it easier to edit the content without worrying about line breaks.
